...
def download_audio(youtube_url):
    try:
        ...
        output_path = os.path.join(temp_dir, "audio.mp4")  # pytube saves mp4 by default
...
def transcribe_audio(audio_path):
    try:
        ...
        trimmed_path = audio_path.replace(".mp4", "_trimmed.mp4")
        trim_command = [
...
# Streamlit UI
st.title("🎧 YouTube Video Transcriber (pytube)")
